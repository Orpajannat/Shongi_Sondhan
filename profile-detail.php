...
<head>
    ...
    <title>Profile Detail - ShongiSondhan</title>
                ...
                <div id="preferences" class="tab-pane">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <p class="info-value">28-35</p>
                        </div>
                        <div class="info-item">
                            <p class="info-label">Height Range</p>
                            <p class="info-value">5'8"-6'2"</p>
                        </div>
                        <div class="info-item">
                            <p class="info-label">Religion</p>
                            <p class="info-value">Islam</p>
                        ...
                        <div class="info-item">
                            <p class="info-label">Education</p>
                            <p class="info-value">Bachelors or Higher</p>
                        </div>
                        <div class="info-item">
                            <p class="info-label">Profession</p>
                            <p class="info-value">Any</p>
                        </div>
                    </div>
                </div>
            </div>
